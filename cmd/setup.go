...
func runSetup(_ *cobra.Command, _ []string) error {
	...
	fmt.Println()
	fmt.Println("Optional alias for ~/.zshrc:")
	fmt.Println("  alias claude-aws='claude-auth exec -- claude'")
	fmt.Println()
	fmt.Println("Optional: auto-refresh if credentials expire mid-session")
